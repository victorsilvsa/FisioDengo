// World 2: Sangue e Hemostasia (6 Níveis, 24 Questões)
const WORLD_2_DATA = {
  "id": "w2",
  ...
  "phases": [
    {
      ...
      "questions": [
        ...
        },
        {
          ...
          "pairs": [
            {
              "item": "Plasma Sanguíneo",
              "match": "Manutenção da pressão oncótica e transporte de metabólitos"
            },
            {
              "item": "Hemácias",
              "match": "Transporte de oxigênio ligado à hemoglobina"
            },
            {
              "item": "Leucócitos",
              "match": "Defesa imunitária e vigilância patogênica"
            },
            {
              "item": "Plaquetas",
              "match": "Hemostasia primária e formação do tampão plaquetário"
            }
          ],
