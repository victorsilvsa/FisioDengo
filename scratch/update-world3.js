      ...
      questions: [
        ...
        },
        {
          ...
          options: [
            ...
            'A duração da fase de ejeção rápida ventricular através da valva aórtica, oscilando entre 0,02 e 0,04 s.',
            'O período refratário absoluto do sistema Purkinje, cuja duração mínima é de 0,35 a 0,45 s.'
          ],
          correctIndex: 1,
        ...
        },
        {
          ...
          options: [
            ...
            'O período de repouso diastólico elétrico absoluto correspondente à fase quatro estável.',
            'A hiperpolarização pós-potencial transitória decorrente do fechamento tardio dos canais retificadores.'
          ],
          correctIndex: 1,
      ...
      questions: [
        ...
        },
        {
          ...
          options: [
            ...
            'A contratilidade ventricular diminui progressivamente à medida que o retorno venoso aumenta para proteger os vasos contra ruptura.',
            'A frequência cardíaca é estritamente independente de estímulos autonômicos ou hormonais endógenos.',
            'O ventrículo esquerdo ejeta todo o seu volume diastólico final esvaziando-se totalmente a cada sístole.'
          ],
          correctIndex: 0,
        ...
        },
        {
          ...
          options: [
            ...
            'O volume diastólico final cai para zero devido à vasodilatação periférica intensa induzida por catecolaminas.',
            'As valvas mitral e tricúspide abrem-se na sístole para dissipar a sobrecarga mecânica atrial.'
          ],
          correctIndex: 1,
        ...
        },
        {
          ...
          options: [
            ...
            'O volume de sangue que preenche o ventrículo na diástole antes da contração, elevado na desidratação severa.',
            'A velocidade máxima com que o nó sinoatrial gera potenciais de ação, elevada durante o sono profundo.',
            'A pressão coloidosmótica do sangue venoso que retorna ao átrio direito, elevada na hipoalbuminemia grave.'
          ],
          correctIndex: 0,
      ...
      questions: [
        {
          ...
          options: [
            ...
            'Estimulam a secreção imediata de renina pelo aparelho justaglomerular para reter sódio.',
            'Disparam constrição reflexa generalizada de todas as arteríolas do território esplâncnico.'
          ],
          correctIndex: 1,
        ...
        },
        {
          ...
          options: [
            ...
            'Induzindo vasodilatação arteriolar periférica imediata mediada pela histamina para elevar a complacência tecidual.',
            'Interrompendo a transmissão neuromuscular nos músculos esqueléticos para diminuir o consumo metabólico de oxigênio.'
          ],
          correctIndex: 1,
        ...
        },
        {
          ...
          options: [
            'Porque seus mecanorreceptores sofrem necrose isquêmica irreversível após 24 horas de estiramento continuado.',
            ...
            'Porque a medula espinhal bloqueia os potenciais do bulbo para proteger os rins contra nefroesclerose.'
          ],
          correctIndex: 1,
...
const output = `// World 3: Fluxo Sanguíneo e Sistema Cardiovascular (6 Níveis, 24 Questões)
const WORLD_3_DATA = ${JSON.stringify(world3, null, 2)};
...
fs.writeFileSync('js/data/world3_cardio.js', output, 'utf8');
console.log('✓ world3_cardio.js gerado com sucesso!');
