    ...
    // Nível 22: w4_p4
    {
      ...
      questions: [
        ...
        },
        {
          ...
          options: [
            'Porque o exercício paralisa a ventilação e reduz o volume corrente para valores inferiores ao espaço morto anatômico.',
            ...
            'Porque os músculos esqueléticos secretam substâncias oxidantes que destroem todas as moléculas de hemoglobina circulante.',
            'Porque os brônquios principais entram em colapso mecânico total por perda das cartilagens de sustentação da traqueia.'
          ],
          correctIndex: 1,
    ...
    // Nível 23: w4_p5
    {
      ...
      questions: [
        ...
        },
        {
          ...
          options: [
            'A substituição do ferro da hemoglobina por átomos de cloro livre para aumentar o transporte de glicose.',
            ...
            'A excreção maciça de cloreto de sódio pelas células parietais gástricas durante a respiração anaeróbica.',
            'A precipitação de cristais de sal nos tecidos musculares periféricos provocada pela hipercapnia arterial aguda.'
          ],
          correctIndex: 1,
        ...
        },
        {
          ...
          options: [
            'A hipotermia tecidual induz a quebra enzimática irreversível do tetrâmero de hemoglobina em dímeros livres.',
            ...
            'A presença de monóxido de carbono no plasma estimula a síntese acelerada de bicarbonato pelos túbulos renais.',
            'Os alvéolos pulmonares utilizam o dióxido de carbono como substrato direto para sintetizar surfactante lipídico.'
          ],
          correctIndex: 1,
    ...
    // Nível 24: w4_p6
    {
      ...
      questions: [
        ...
        },
        {
          ...
          options: [
            'Alvéolos hiperventilados que recebem perfusão sanguínea nula devido à embolia arterial maciça.',
            ...
            'Vasodilatação capilar sistêmica grave com extravasamento de plasma para o tecido subcutâneo.',
            'Paralisia do centro respiratório dorsal bulbar induzida por hipoxemia tecidual refratária.'
          ],
          correctIndex: 1,
        ...
        },
        {
          ...
          options: [
            'A queda da PO₂ arterial abaixo de 95 mmHg captada diretamente pelo nervo vago.',
            ...
            'A concentração plasmática de nitrogênio livre dissolvido na circulação coronariana.',
            'A osmolaridade sérica regulada pelos osmorreceptores do núcleo supraóptico.'
          ],
          correctIndex: 1,
        ...
        },
        {
          ...
          options: [
            'Acelerar a frequência respiratória quando o pH plasmático se torna excessivamente alcalino.',
            ...
            'Bloquear a circulação pulmonar durante a manobra de deglutição de alimentos sólidos.',
            'Estimular a secreção de ácido clorídrico gástrico durante o sono de ondas lentas profundo.'
          ],
          correctIndex: 1,
...
const output = `// World 4: Sistema Respiratório (6 Níveis, 24 Questões)
const WORLD_4_DATA = ${JSON.stringify(world4, null, 2)};
...
fs.writeFileSync('js/data/world4_respiratorio.js', output, 'utf8');
console.log('✓ world4_respiratorio.js gerado com sucesso!');
